...
const Signup = () => {
  ...
  return (
    <section id="signup" className="w-full min-h-[calc(100vh-72px)] py-14 flex justify-center hero-bg">
      {/* Sign Up Form */}
      <form ref={formRef} onSubmit={handleSubmit} className="form-container-style">
        <img src={logo} alt="Sakura Study Logo" className="w-12 h-12 mx-auto mb-2" />
        ...
        <div className="w-full flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <input className="form-input-style px-3 py-2" type="text" id="username" name="username" required />
          </div>
          {/* Email Field Wrapper*/}
          <div className="flex flex-col gap-1">
            ...
            <input className="form-input-style px-3 py-2" type="email" id="email" name="email" required />
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="relative">
              <input className="password-input" type={showPassword ? "text" : "password"} id="password" name="password" autoComplete="off" required />
              {/* Show password button */}
              <button type="button" onClick={() => setShowPassword(!showPassword)} className="password-show-btn">
        ...
        {/* Submit Button */}
        <button className="w-full mt-6 py-3 px-6 bg-primary hover:bg-primary-shade text-white font-bold rounded-xl" type="submit">
          {loading ? <AiOutlineLoading className="animate-spin h-6 w-6 mx-auto" /> : "Create account"}
        </button>
        {/* Login Link */}
        <p className="mt-6 text-gray-500 dark:text-gray-400 text-center">Do You Wanna Add New Users? </p>
      </form>
    </section>
  );
};
